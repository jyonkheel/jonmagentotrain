...
return [
    'modules' => [
        ...
        'MSP_TwoFactorAuth' => 1,
        'Part2Unit1_CustomerFormDump' => 1,
        'Part2Unit1_HelloMiniCart' => 1,
        'Part2Unit1_JsDataProvider' => 1,
        'Part2Unit1_SimpleUiComponent' => 1,
        'Part2Unit1_StandaloneXhtmlTemplate' => 1,
        'Part2Unit2_AccessData' => 1,
        'Part2Unit2_ComputerGames' => 1,
        'Part2Unit2_ConfigurableProducts' => 1,
        'Part2Unit2_CustomButton' => 1,
        'Part2Unit2_CustomFilterSkeleton' => 1,
        'Part2Unit2_NewCustomerTab' => 1,
        'Part2Unit2_ProductSeries' => 1,
        'Part2Unit2_RequireVerification' => 1,
        'Temando_Shipping' => 1,
        'Unit1_Plugins' => 1,
        'Unit1_Test1' => 1,
        'Unit1_Test2' => 0,
        'Unit2_CatalogProductPlugin' => 1,
        'Unit2_FlushOutput' => 1,
        'Unit2_HelloWorld' => 1,
        'Unit2_RouterDash' => 1,
        'Unit2_RoutersLog' => 1,
        ...
        'Unit3_TemplateBlock' => 0,
        'Unit3_TestBlock' => 1,
        'Unit4_CustomPriority' => 1,
        'Unit4_MultiSelect' => 1,
        'Unit4_ProductSave' => 1,
        'Unit4_RootCategories' => 1,
        'Unit4_TextInput' => 1,
        'Unit4_VendorEntity' => 1,
        'Unit5_CustomerList' => 1,
        'Unit5_ProductList' => 1,
        'Unit5_Repository' => 1,
        'Unit6_AdminMenu' => 1,
        'Unit6_AdminPage' => 1,
        'Unit6_SystemConfiguration' => 1,
        'Vertex_Tax' => 1,
        'Yotpo_Yotpo' => 1
    ]
];
